...
const MOOD = ["своя земля","родная кровь","одно лицо","резкие тени","стылые поля","чёрная вода","сухие деревья","лошади в тумане","грубое полотно","бледные лица","ни одной улыбки","застывшее время","тихо и строго"];
...
const RULES = [
  ...
  "Снимаем при дневном свете, 15:00–18:00 — жёсткое боковое солнце даёт резкие тени, к концу свет уходит в низкий золотой. Холод приходит на цвете: на посте уводим картинку в сланец и пепел.",
  "Кастинг-двойники — одна бледная кожа и почти одинаковые лица читаются как одна тихая кровь. Никаких улыбок, никогда.",
  "Сдержанно-амишский гардероб — простые платья, кружевные чепцы, клетчатая шерсть; скромно, но не наглухо.",
  "Одичавшая земля как сцена — голые деревья, чёрная вода, покосившиеся изгороди, небеса в синяках; лошади на воле. Ничего ухоженного.",
...
const LINEAGE = [
  ...
  { group:"Мода", items:[
    ...
    ["ROUW — Rituals from Zeeland", "Van Drimmelen — главная визуальная опора серии — траурные женщины в кружевных чепцах и сельском платье."]
  ]}
];
